<template>
  <div id="app">
    ...
    <div class="bottom">
      ...
      <show-recipees v-bind:name="recipees[0].name" v-on:my-event="shoppingList"
      v-on:event-hide="hideShoppingList"
      v-bind:description="recipees[0].description" v-bind:preparationTime="recipees[0].preparationTime"
